...
argocd app create nexus --repo=https://github.com/redhat-canada-gitops/catalog --path=nexus2/base \ 
  --dest-server=https://kubernetes.default.svc --dest-namespace=argocd-managed --sync-policy=auto
